...
export default function AsyncWorkspaceCreate(props) {
  ...
  return (
    <div style={mobileStyle(props.isTabletOrMobile)}>
      ...
      >
        <StyledHeadings>New Workspace</StyledHeadings>
        <TextField
          fullWidth
          size="large"
        ...
        >
          <div>
            <StyledDot id="pink" onClick={handleColorChange} bg={"#FFE6E3"} />
            <StyledDot id="purple" onClick={handleColorChange} bg={"#A0A0FA"} />
            <StyledDot id="green" onClick={handleColorChange} bg={"#D0FCDB"} />
            <div
              styles={{
                display: "flex",
                justifyContent: "center",
            ...
            >
              <StyledDot id="lightBlue" onClick={handleColorChange} bg={"#CEDDFF"} />
